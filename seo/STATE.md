...
phases:
  ...
  "2": { status: in_progress, branch: seo/02-nextjs, chunk: "c2-seo shipped (/compatibility, /search, /keywordsearch SEO-shells); c2-tools pending (4 noindex routes /match, /stl-match, /compare-prices, *-legacy — depends on c4); c3 guides/knowledge, c4 heavy interactives [Map/AISearch/PriceCalc/Shapeways], c5 admin/auth/embed pending" }
  "3": { status: pending }
  "4": { status: pending }
  "5": { status: pending }
  "6": { status: pending }
