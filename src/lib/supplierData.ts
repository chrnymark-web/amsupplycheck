...
const supplierDescriptions: Record<string, string> = {
  ...
  'aml3d': "Australian metal additive manufacturing company specializing in large-scale Wire Arc Additive Manufacturing (WAAM). Expert in titanium, aluminum, and steel components for aerospace and defense.",
