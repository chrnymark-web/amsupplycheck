...
import { useSupplierMatching, ProjectRequirements, MatchResult } from '@/hooks/use-supplier-matching';
...
export default function ProjectMatch() {
  ...
  const { isLoading, error, result, matchProject, reset } = useSupplierMatching();
