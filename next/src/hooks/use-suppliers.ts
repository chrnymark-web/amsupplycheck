  ...
  return useQuery({
    ...
    queryFn: async (): Promise<SupplierListItem | null> => {
      ...
      return {
        ...
        technologies: (techs.data || []) as unknown[],
        materials: (mats.data || []) as unknown[],
        certifications: (certs.data || []) as unknown[],
        tags: (tags.data || []) as unknown[],
        country: country.data as unknown,
      };
    },
