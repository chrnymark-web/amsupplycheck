...
import type { MatchResult } from "@/lib/supplier-matching-types";
...
interface StlMatchLegacyClientProps {
  technologyToMaterials: Record<string, string[]>;
}

export default function StlMatchLegacyClient({ technologyToMaterials }: StlMatchLegacyClientProps) {
  ...
  const materials = technologyToMaterials[technology] || [];
  const technologyOptions = Object.keys(technologyToMaterials).sort();
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select value={technology} onValueChange={(v) => { setTechnology(v); setMaterial(technologyToMaterials[v]?.[0] || ""); }}>
